...
**Identity:** highest Magic/MP elemental specialist; deliberately fragile  
**Trait:** **Prismatic Flow**  
**Ultimate:** **Arcanum Ascendant**
...
|---:|---|---|
| CL3 | **Elemental Memory** | Prismatic Flow qualifying final-damage bonus +10% → +15%. |
| CL6 | **Elemental Fluency** | The four early fixed matching-status Abilities increase listed base status chance 20% → 25%; Vaelira's separate +5pp specialist bonus still applies afterward. |
