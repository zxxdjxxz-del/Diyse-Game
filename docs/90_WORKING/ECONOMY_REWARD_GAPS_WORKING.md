# Working — Economy / Reward Gaps

**Owner:** `12_ECONOMY_AND_REWARDS`
...
- ordinary formations: approximately **13.56k Auren** of that total (~45%);
- all current optional direct-cash packages add approximately **19,390 Auren**;
- full direct-cash completionist path before resale: approximately **49,517 Auren**;
...
## Locked boundaries
- currency = Auren;
- current Consumable catalog = 20;
- ordinary equipment catalog = 38;
- Cresthaven Quartermaster = ordinary-equipment backfill authority;
- Relics/Legacies/project materials are not ordinary shop stock by default;
- optional-content money must not be required for baseline story solvency;
- do not create vendor-trash or generic monster-part economies to fill remaining gaps.

When a remaining item is resolved, update `12_ECONOMY_AND_REWARDS` first, then shrink this working file again.
