...
|---:|---|
| **CL1** | Gain legal use of Ilyra's **Wardrods**. |
| **CL3** | Gain legal use of **Warding / Blue Warden armor**. |
| **CL5** | Gain the donor's legal advanced Secondary package: **Shield** plus **Focus** where legal. |
| **CL10** | Equipment Mastery becomes eligible; buying Subclass Mastery Node 4 grants access to the Blue Warden donor **Relic**. |
| Synthesis | Later paired Legacy access under the final Synthesis rule. |

Seyrik's native Two-Handed Sword permissions remain persistent under the open-equipment rule.
...
After total eligible damage is resolved, healing equal to **12% of that total eligible HP damage** is distributed among conscious allies under the inherited authored distribution rule, capped at **15% Max HP per ally**.

### CL11 — Reclaimed Breath
**24 MP; one incapacitated permanent ally.**

- Returns the ally at **25% Max HP**.
- Cannot target summons, devices, or Prime Manifestations.
- Does not deal damage, Drain, create a special revival state, or create a new resource.
- Deliberately remains weaker at pure revival than Ilyra's native Blue Warden Revive.

## 6. Approved Ultimate — Mercy Through Ruin

**CL13; all enemies + all conscious allies.**

- Deals **320 Colorless Magical Power** to all enemies.
