...
4. Apply equipment bonuses afterward.

For **Max HP / Max MP equipment**, step 4 uses persistent percentage modifiers:
- sum all legal equipped Max HP percentages and Max MP percentages separately;
- cap each equipment-derived resource bonus at **+30%**;
- calculate the bonus from the rounded selected-class natural Max HP / Max MP;
- round the equipment bonus to a whole number, with exact .5 rounding up;
- add that rounded bonus to the selected-class natural Max HP / Max MP.

Equipment Max HP / Max MP percentages stack additively rather than multiplying one another. Exact equipment authority is `08_ITEMS_AND_EQUIPMENT/HP_MP_PERCENT_BONUS_RULES.md`.
