...
- establish that the Crown will not separate Cyanis from the Card until it understands why the artifact is affecting him;
- give the party an immediate expert lead into the Old City archives.
...
- the Queen explicitly decides that **Cyanis is to keep possession of the Card for now**.
- this is not because the Crown has concluded he is its rightful bearer or owner; no such identification has been made.
- the reason is practical and cautious: the Card has repeatedly shown an unexplained effect / response connected to Cyanis, and the Crown does not yet know what forced separation, transfer, or prolonged distance from him might do.
- until more is understood, the Queen will not order an unnecessary custody experiment with an Ancient artifact already behaving abnormally around one person.
...
- Cyanis keeps the Card under Maevra's responsibility until the Crown understands more about its effect on him.
...
**Gameplay handoff**
→ **Beat 2 — Orders the Queen Never Gave / legacy S018**, with the **Old City Card expert** established as an immediate investigative destination.
...
- combine the documentary investigation with Mirena's existing lead that a top Card expert is working in the Old City archives;
...
- lead the party into the **Old City archives / suppressed judicial repository** beneath / within the older Caelora layers.

**Starting state**
- the party is free to move in Caelora.
- Cyanis still carries the Card by the Queen's direct permission because its unexplained effect on him makes forced transfer / separation unjustified until more is known.
...
- the Queen / Mirena grants Maevra and the party lawful access to the restricted portions needed for the investigation.
...
- a confirmed bearer relationship between Cyanis and the Card;
...
- Cresthaven;
- Nimera's later party role before the party actually meets her.
...
- sealed Card resolves to stable deep Ruby;
