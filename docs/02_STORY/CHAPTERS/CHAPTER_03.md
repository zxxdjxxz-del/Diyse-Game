...
- the party retains its copy/record of the **Chapter-1 Wayfinder**.
- the physical Wayfinder itself is **Ancient Diysean and thousands of years old**.
- its surviving western-region information is extremely precise, but the artifact is physically broken through the center of the ancient-capital concentration corresponding to modern Caelora.
- it already established a vast western network, many built-up sites, and a huge concentration around the known location of the ancient capital.
- educated/current characters already know that an Ancient capital existed where modern Caelora stands; **Chapter 3 must never treat the existence of that capital as a new discovery**.
- what remains unknown entering Chapter 3 includes the full scale/shape of that capital concentration, the complete route pattern through the broken center, the significance of the mysterious second marking system, and what lies farther north.
- Rhazek remains alive after withdrawing from the Old Bastion.
- previously transferred captives remain missing.

## Retired opening / map premises

Do not restore:
- the deleted Chapter-2 Western Map Mural;
- a Chapter-2 map showing an enormous Ancient city at Caelora;
- a Chapter-2 northern structure bearing the exact modern Yahtrean Crest;
- a Chapter-2 cartographic reveal that fills the Chapter-1 Wayfinder break;
- party containment / detention on arrival;
- automatic Card seizure;
- forced conflict with lawful Crown personnel over the Card;
- the old composite-order theory;
- digital/software-style royal administration.

The central royal mystery remains:
...
- environmental layering may show that the modern city sits over older construction;
- do not frame the existence of an Ancient capital beneath/at Caelora as a revelation.
...
**Purpose:** transfer Chapter-2 outcomes into Crown knowledge without reviving the deleted Chapter-2 mural.
...
**Purpose:** turn the report into Chapter 3's central Crown investigation.

Mandatory:
- the physical Card-transport orders are produced;
- they look like plausible Crown documents rather than obvious villain forgeries;
- Lysara establishes that before this audience she knew nothing about this recovered Card or its transport toward Caelora;
- therefore she could not knowingly have authorized those Card-specific orders;
- Calder publicly minimizes the logic of spending Crown resources on an apparently inactive Card;
- writer-facing truth remains that Calder himself ordered the Card transported toward Caelora;
- nothing exposes that hidden role to the party;
...
- Cyanis keeps physical possession of the Card for now;
- this does not establish bearer status, Prime, Might, or Last Sentinel;
- Lysara orders examination of the actual seal, custody, legitimate uses, comparison documents, and access history.
...
- legitimate recent documents and the suspect orders share the same recognized core royal magical authority response;
- ordinary copying of crest shape, wax, ink, handwriting, or formatting cannot explain the response;
- custody/access history reveals no simple documented theft-and-return explanation;
- custody is not declared infallible;
- two broad possibilities remain open:
  1. unauthorized physical access without an obvious record;
...
Retired cleanup Character-Life:
- H02;
- H04.
...
> **Ivorybridge — chosen as the next practical place to investigate the northbound Ancient-route lead, not identified as a confirmed Ancient endpoint.**
...
- suspect orders nevertheless carry her genuine magical royal-authority response;
- her real seal remains present and functions normally;
...
- that regional copy covers the Westways and central Yahtrea only;
- the copied map shows the complete ancient Caelora cluster, major routes radiating outward, and a huge northern tower;
...
- exact mechanism behind the unauthorized genuine royal response;
- meaning/function of the Wayfinder's mysterious second marking system;
...
- Prime classification;
- Might classification;
- Last Sentinel recovery, manifestation, awakening, or use; **the next locked state change is its transition into Recovered during the Chapter-4 Elder Thornhide battle.**

---

# Dialogue Production Rule

Chapter 3 uses the current rehearsal-first production pipeline:
...
- party state;
- reveal firewalls;
- exact preserved lines where applicable.

Current exact dialogue files written for the superseded structure must be treated as **stale until migrated to this revision**.
