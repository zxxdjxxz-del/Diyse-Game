...
## Hidden approach
The elder reveals an old waterworks service route. It is old local infrastructure, not a newly discovered magic tunnel; not introduced as Diysean ruins; not known to lead directly to prisoners; unrelated to poisoned water; and plausible for a small covert team.
...
## Reveal firewall
No Archive name/function, western map, Leviathan, secret prisoner passage, exact captives, Rhazek philosophy, Seyrik, Last Sentinel, or complete ancient network.
...
- clearly older than Dunmere's waterworks and the Red Transfer Bastion.
...
## Reveal firewall
No western-map information yet, huge Caelora-location city, full eastern continuation, Leviathan reveal before setup window, secret prisoner passage, prisoner details, Rhazek, Seyrik, Last Sentinel, Cresthaven, or complete system explanation.
...
## Reveal firewall
No eastern half, ancient city's formal identity/history, complete network purpose, definitive terrain explanation, Cresthaven, Last Sentinel, buried-Crest truth, Entity, secret prisoner passage, prisoner details, Rhazek, or Seyrik.
...
## Playable role
This is the main post-mural exploration-pressure section. Give the player meaningful traversal before the boss. Later map design may use deeper flooded chambers, altered elevations, degraded archive spaces, side paths, barriers, failed systems, local creatures, hazards, or defensive remnants.

## Escalation rule
The deeper Archive becomes less stable/safe. Environmental signals may imply that something large or dangerous occupies the route ahead, but exact foreshadowing should match later encounter implementation.
...
## Route-pressure rule
There is no clean alternative route around the coming boss. The viable continuation toward the Bastion converges on the section occupied by the threat.

## Occupation / covert rule
No routine Black Host presence. Covert infiltration remains intact.
...
## End state / handoff
Party has pushed significantly deeper, still has no direct prisoner/Host contact, and must confront/pass through the major threat to continue.

→ **Beat 8 — Archive Leviathan**

## Reveal firewall
No complete Leviathan origin/function, secret passage, prisoner details, transfer-record replacement clue, Rhazek philosophy, Seyrik, eastern map, ancient Caelora formal identity, Cresthaven, Last Sentinel, buried-Crest truth, or Entity.
