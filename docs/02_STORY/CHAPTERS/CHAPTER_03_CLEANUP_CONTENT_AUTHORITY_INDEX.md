...
- Nimera has already spread highly organized work across most of the main table;
- Cyanis and Torren enter already halfway through absurdly vicious but safe banter;
- exact preserved anchors, verbatim and in this order:
  - **Cyanis:** `I bet you use that cape to sneak up on the goats you fuck.`
  - **Torren:** `You look like a walking dick in armor.`
- Nimera quickly realizes this is their established dynamic and enjoys it;
...
## Structural audit / consolidation status
