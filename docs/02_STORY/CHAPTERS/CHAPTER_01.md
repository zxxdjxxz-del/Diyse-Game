...
**Purpose**
- establish the deliberate Card-separation failure;
- put Maevra in operational responsibility for the Card/Cyanis problem;
- establish Caelora as the larger destination and Greenhollow/Torren as the immediate next step.

**Current sequence**
- one continuous mandatory Brackenwall intake sequence;
- attempted transfer/storage separates the Card from Cyanis;
- Cyanis reacts badly and the Card responds toward him;
- returning the Card stops the reaction;
- Maevra is brought in immediately;
- Card stays with Cyanis; Ilyra monitors only real changes;
- Maevra travels with the group but does not fight because of her broken arm;
- player control returns in Brackenwall to prepare for Greenhollow.
...
**Purpose**
- make the first Briar leg a readable travel area rather than a route puzzle;
- establish that Maevra knows this stretch but wants Torren for the more changeable southern routes.

**Current sequence**
- normal Brackenwall-to-Greenhollow traversal;
- no guided/walking dialogue;
- exactly one authored stop roughly halfway at a natural break;
- no false trail, route split, crossing, Old Waystone, or Greenhollow threshold conversation;
- route remains comparatively legible;
- arrive in Greenhollow through normal gameplay.
...
**Purpose**
- introduce Torren through his actual field role and old familiarity with Maevra;
- establish the direct-road problem and Hollow Watch as the obstacle that must be resolved first.
...
- short aftermath only;
- route to the Junction opens.
...
**Purpose**
- pay off the Hollow Watch mural and reveal the hidden cartographic monument at the familiar Junction crossroads.
...
- southeast alignment matches the party's already-planned Dunmere-bound route;
- water/cistern notation matches the earlier late Southern Briar side access and makes it worth revisiting;
- one damaged edge remains unresolved;
- party copies only surviving useful information;
