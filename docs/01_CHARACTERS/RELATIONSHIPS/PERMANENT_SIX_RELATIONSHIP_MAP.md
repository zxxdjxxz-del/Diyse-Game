# Diyse — Permanent Six Relationship Map
...
**Domain rule:** this folder owns character identity, biography, chronology, personality, relationship logic, and concise voice direction. Exact class mechanics live in `06_CLASSES_AND_ABILITIES`; Card/Prime mechanics in `07_CARDS`; detailed art specifications in `14_ART_AND_VISUALS`; exact dialogue scripts live in `03_DIALOGUE`.

This is a character-logic map, not a substitute for exact dialogue scripts. It also preserves the compatible pair-specific conversational languages from the completed Diyse dialogue-development study so persistent character agents do not collapse six personalities into generic "party dialogue."
...
| Cyanis / Vaelira | leadership and measured technical precision | different kinds of intelligence; practical-boundary questions versus cleaner models; low-stakes prediction/efficiency competition; increasingly playful challenge without turning Cyanis into common sense and Vaelira into abstract theory |
...
| Nimera / Vaelira | evidentiary/historical reconstruction meets causal/hypothesis-driven scientific reasoning | fast friendship and dangerous intellectual chemistry; records/proof versus mechanisms/tests can become recreational argument, games, scoring, and mutual escalation; Nimera is faster/profaner/category-focused while Vaelira stays more controlled/causal/conditional; never merge them into one smart-character voice |
| Nimera / Seyrik | curiosity must distinguish evidence from personhood | conversational opposites; her speed against his precision creates strong dry-comedy potential |
| Vaelira / Seyrik | precision without infantilization; directness can be useful to both | serious intellectual compatibility around dangerous systems plus unusually dry mundane disagreement; Vaelira respects direct questions and asks Seyrik's preference without embedding a correct answer; precision may become deliberate deadpan humor, never case-study treatment |
...
- **Chapter 3:** first-contact friction, curiosity, professional respect, reciprocal correction, and occasional accidental comedy. No established father/daughter shorthand and no `dad thing` jokes yet.
- **following chapters:** reciprocal Routeweaver/Proofhunter training, travel, repeated arguments, practical favors, remembered habits, and increasing trust make the bond personal.
- **later:** the relationship can become unmistakably father/daughter-like in affection and protectiveness while Nimera remains fully adult, autonomous, capable of refusing Torren, correcting him, and outperforming him in her own domain.

Do not write the late-stage familial bond backward into their first chapter together.

## Misunderstanding rule

The cast does not possess writer-level psychological insight.

Characters may misread one another in plausible ways. Examples inherited from the dialogue study include:
- Ilyra can misread silence;
- Torren can mistake a choice for recklessness;
- Nimera can mistake exhaustion for avoidance;
- Seyrik can read disagreement as rejection;
- Vaelira can misunderstand emotional meaning;
- Cyanis can misjudge what kind of help someone actually wants.

Trust should allow correction rather than magical mind-reading.

## Ensemble rule

The six are not six therapists completing one another.
...
- disagreement that does not threaten belonging.

A six-person scene does not require six lines. Selective participation and separate simultaneous social geometry are preferred to party roll call.
