...
Mechanical class details belong in `06_CLASSES_AND_ABILITIES`.
...
He has a recurring habit of treating:
- food;
- rest;
- injury;
- his own limits

as things to address after everyone else is safe.
...
## Knowledge boundary
Crest Knight expertise allows him to recognize relationships to modern Crest geometry.
It does **not** grant lost ancient Network/Entity/Last-Weapon knowledge before the story earns it.

## Relationship shorthand
- Ilyra — parallel care/self-neglect; neither becomes the other's therapist.
...
- Nimera — compatible curiosity and skepticism toward authority, with different expertise.
- Maevra — respects competent command that can update when evidence changes.

## Voice shorthand
Clear, practical, fast, dryly funny.
He can be witty without becoming a quip machine.
Under real pressure, his language gets more functional rather than grander.

## Visual
Exact approved playable visual master: **LOCKED**.
Detailed art authority belongs in `14_ART_AND_VISUALS`.
