...
1. Current standalone Chapter-4 atomic dialogue files become exact spoken-wording authority **only after authored, Canon Checker PASS, and explicit author approval**.
2. Current scene-authority specs define bounded story context / reveal firewalls for rehearsal.
3. `docs/02_STORY/CHAPTERS/CHAPTER_04.md` owns mandatory Chapter-4 story structure and outcomes.
...
Generated rehearsal/editor output is not canon by generation alone.

Only:
> **Canon Checker PASS + explicit author approval**

may promote a scene or story-memory delta into persistent production continuity.
...
- Player explicitly starts Chapter 4 from Chapter-3 Cresthaven cleanup.
- Opening is the next morning.
