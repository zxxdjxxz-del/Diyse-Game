...
- Beat 3 — impossible orders / authentication;
...
- Beat 14 — rest in Caelora / four-person decompression;
- Beat 15 — Cresthaven operational handoff.

**Audited and intentionally preserved as predominantly terse/mixed because the situation earns it:**
- Beat 1 — arrival/guidance banter;
- Beat 4 — restricted seal-custody investigation after prior closing-audit rerun;
- Beat 5 — archive access / practical keeper guidance;
- Beats 6–7 — barrier problem-solving / first cooperation;
...
## Current chapter end state

- Nimera permanently joins in Beat 8.
- permanent current resident/traveling party at Cresthaven: **Cyanis + Ilyra + Torren + Nimera**.
- Cyanis's Card becomes stable deep Ruby only after the First Command Warden is fully inert; no causal mechanism is claimed.
- the copied royal-seal experiments prove sophisticated attempts, not successful duplication of Lysara's genuine magical authority response.
- recent reader / seal practitioner identity remains unknown.
...
Prior chapter-wide integration audit:
