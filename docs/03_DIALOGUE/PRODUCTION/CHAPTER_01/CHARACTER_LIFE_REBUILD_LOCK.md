...
- respect Chapter-1 relationship maturity: Torren has only just joined permanently, so Cyanis/Torren sharp affectionate profanity is beginning to emerge rather than already sounding like a late-game routine;
...
- let Torren become more talkative naturally around roads, maps, food, terrain, weather, and other things he actually cares about;
- let Cyanis be pleasant company rather than only the person everyone manages;
- avoid therapy language, writer-level diagnosis, and optional-scene lore delivery;
