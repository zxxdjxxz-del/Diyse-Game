...
**Combined read-through:** `CHAPTER_01_DIALOGUE_MANUSCRIPT.md` — current synchronized derived mirror.  
...
- practiced old-married-couple-style arguing;
- unusual knowledge of each other's habits and likely reactions;
- Maevra stubborn around duty/responsibility;
- Torren stubborn around ground truth/practical judgment.

Chapter 1 must not reveal:
- exact history duration;
- enlistment ages;
- past romantic/lovers status;
- sexual history;
- breakup/reunion history;
...
If Chapter-1 sources disagree:
1. current Chapter-1 story authority + later explicit user corrections;
2. current character authority;
3. current runtime Person Brains;
4. current Character-Life numbering/content locks;
5. current scene specs for guardrails/outcomes;
