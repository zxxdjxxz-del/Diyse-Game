...
The atomics remain exact wording authority. The Chapter 1 combined manuscript, current runtime mirror, synchronization manifest, and Chapters 0–3 exact-dialogue reader have all been regenerated from the locked atomic set and verified current.
