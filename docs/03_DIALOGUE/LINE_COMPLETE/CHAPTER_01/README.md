# Chapter 1 — Line-Complete Dialogue
...
Current corrections reflected here:
- Acuity is the active Face terminology where relevant.
- C04 current final gag uses **“old slut”**, not the superseded “old whore” reconstruction.
- S009's future-system firewall says **Sixfold Volition**, not Sixfold Accord.

Do not rewrite accepted spoken text except through explicit change control.
