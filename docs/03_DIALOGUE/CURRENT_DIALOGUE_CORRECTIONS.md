# Diyse — Current Dialogue Corrections
...
### Ch1 S007 — BRACKENWALL / PROTOCOL — REOPENED
Historical S007 is voice/staging reference only.

Current authority supersedes it as follows:
- Brackenwall remains active and functioning.
- Cyanis and Ilyra arrive with the recovered sealed Ancient/Card-family artifact.
- the formal custody-transfer attempt causes another abnormal proximity-related response around Cyanis; the transfer is stopped rather than repeatedly tested.
- **the Card remains with Cyanis / the traveling group.**
- Maevra takes responsibility for the situation.
- larger destination becomes **Caelora** for proper investigation / authority.
...
- Maevra travels with Cyanis and Ilyra but **never becomes a combat participant**.

Retired from old S007:
- a Hollow Watch scout report launching the chapter directly from Brackenwall;
- immediate Brackenwall → Hollow Watch travel;
- `MAEVRA SOLMAR — TEMPORARY PARTY MEMBER` or any Maevra battle state;
- any staging that leaves the Card behind in Brackenwall custody.
...
Current authority:
- S008 occurs **after Greenhollow**.
- Torren accompanies the group as a temporary combat-capable ally; battle party is **Cyanis + Ilyra + Torren**.
- Maevra is physically present in story/investigation staging but never participates in battle.
- Hollow Watch is a small Yahtrean cliff-side fort built over an older Diysean ruin.
- the Black Host seized it roughly one week earlier and has spent that week excavating below it; this is known before arrival.
- the Yahtrean Hollow Watch **garrison was killed** during / following the seizure. There is no surviving-garrison rescue objective.
- the surface fort establishes that the Host's real interest is the structure beneath it.

Lower-ruin material still compatible with current story authority:
- organized Black Host excavation: digging/pry tools, cleared or scrubbed stone, debris, forced access, and evidence of sustained excavation;
- later Yahtrean construction/controls visibly integrated with older green-gold Diysean machinery where useful;
- active Diysean Sentries / defenses, subject to live encounter authority;
- circular lower junction with **six damaged channels**;
- human-use imagery showing adults, children, handcarts, animals, and injured people on litters moving through a gate/passage system;
- ambiguity over evacuation, transit, shelter, or some broader original function;
- a forced inner breach leading to the Castellan;
- Hollow Watch Castellan as the major mid-chapter boss, including architectural/integrated presentation and same-HP-bar mobile state unless battle authority revises mechanics;
- **Faultline Sight** first-clear Standard Card only if still supported by current Card/encounter authority.

Current Castellan causality:
- Cyanis is carrying the recovered Card when the party reaches the protected Castellan area.
- **the Castellan reacts/activates because the party has brought the Card there.**
- this is true underlying causality but must **not** be explicitly stated, confirmed, or explained in Chapter 1.
- dialogue may register strange timing, but cannot correctly identify recognition, authorization, bearer status, Prime identity, or Last Sentinel meaning.

Current post-boss Hollow Watch payoff:
- after the Castellan, the party finds a large protected Diysean **mural**;
- balls of fire fall from the sky;
- people move downward into multiple deep tunnel entrances in different geographic locations;
- recognizable terrain makes the mural partly map-like;
- Torren recognizes the hill Hollow Watch stands on;
- Torren also recognizes a prominent southern formation resembling **Wayfinder Junction**;
- **Wayfinder is not depicted as a tunnel entrance**; it is simply represented as clearly important for an unknown reason.

Retired from old S008:
- early Hollow Watch map rubbing / portable cartographic rubbing as a story clue;
- old route-like rubbing payoff;
- separate post-Castellan **route plate**;
- old directional dialogue that sends the party next to Greenhollow;
- old Cyanis/Ilyra/Maevra battle-party staging;
- any explicit explanation of the Card–Castellan relationship.

**The post-Castellan mural is Hollow Watch's sole major cartographic payoff.**

After Hollow Watch is resolved, Torren formally becomes a permanent party member and continues south as the Briar Passage guide.

### Ch1 S009 — GREENHOLLOW / TORREN — REOPENED
Historical S009 remains source material for compatible character voice and staging fragments only.

Current authority:
- Maevra intentionally brings Cyanis and Ilyra to **Torren Harth** because she needs his regional route expertise for Briar Passage.
- Maevra and Torren's pre-existing familiarity remains.
- Maevra tells Torren the larger destination is **Caelora** and briefs him on Cyanis's recovered abnormal Ancient/Card-family artifact within current knowledge limits.
- Torren already knows the **Black Host seized Hollow Watch roughly one week earlier** and has been excavating beneath it.
- Torren does not yet know the garrison was killed or the Host's exact objective.
- Torren agrees in principle to guide the group south, but refuses to leave until Hollow Watch is investigated.
- Torren becomes combat-capable for Hollow Watch but **does not permanently join in Greenhollow**.
- Maevra remains non-combat.

Retired from old S009:
- stranded civilians;
- mandatory Lower Woods rescue;
- Greenhollow Briarhide Stalker battle;
- permanent Torren recruitment before Hollow Watch.

Compatible historical material such as the route-board setup, Torren's route-specialist behavior, Maevra/Torren familiarity, Edda/family texture, and useful voice fragments may be reused only if they fit the rebuilt beat.

### Ch1 S010 — SOUTHERN BRIAR — STRUCTURALLY REPLACED
Historical S010 is not current scene structure. It may supply isolated compatible voice/performance fragments only.

Retired:
- false trail;
- authored route split / overlook decision;
- lower-vs-upper route choice sequence;
- damaged crossing / civilian crossing;
- separate Old Waystone;
- any statement that Torren is the **fourth** active party member in Chapter 1;
- any old story logic tied to the removed Greenhollow recruitment sequence.

Current southern Briar authority:
- occurs after Hollow Watch and **after Torren permanently joins**;
- active combat party is **Cyanis + Ilyra + Torren**;
- Maevra travels but does not fight;
- southern Briar is a substantial exploration/story area with side paths and route expertise;
- Hollow Watch supplied the Ancient mystery setup; southern Briar should not add another major Ancient reveal;
- during ordinary southward traversal, **Torren points out a heavily overgrown old side access / stone-lined opening** branching away from the usable route;
- Torren can note that it looks too overgrown to be a sensible path and that it is **not the direction they are heading**, so the party leaves it alone and continues. Exact wording belongs to the Dialogue Engine;
- the party does **not** yet know that this overgrown Briar-side access is connected to the later Cistern Devourer Hunt;
- the Wayfinder-like formation from the mural becomes increasingly recognizable as the party travels south;
- the **Briarhide Stalker is simply an exceptionally strong wild beast**, not corrupted, controlled, altered, fitted with Host equipment, or carrying a special condition;
- buildup may use predator signs and a later sighting;
- the Stalker is defeated in a normal boss fight through ordinary combat and is the Chapter-1 final boss.

### Ch1 S011 — WAYFINDER JUNCTION — CORE FUNCTION PRESERVED / TRANSCRIPT MIGRATION REQUIRED
The core Wayfinder location and discovery sequence remain current, but the historical transcript contains obsolete connective material and terminology. Do not use it line-for-line without migration.

Preserve:
- large weathered Ancient crossroads with multiple old Diysean roads;
- broad stone-and-metal Wayfinder cartographic monument built into the crossroads / formation;
- safe post-boss discovery area with no random encounters, boss, hidden final fight, collapse, or antagonist sting;
- Black Host excavation traces/tools but no waiting Host troops;
- Torren reading physical geography and old route alignment;
- Six Faces appearing in an Ancient technical/cartographic grammar the party does not understand;
- no magical Card reaction at Wayfinder;
- old water/cistern notation that gives the party enough information to connect the notation with the **overgrown side access they already passed in southern Briar Passage**;
- **Wayfinder itself is not the Cistern Devourer entrance**;
- damaged/broken edge remaining unresolved;
- party making practical physical copies of useful information.

Current Dunmere-route meaning:
- **Dunmere was already the party's intended next destination before the Wayfinder scene.**
- the Wayfinder does **not** newly tell the party to go to Dunmere;
- instead, its southeast alignment corresponds to the route they were already taking toward Dunmere;
- this reveals that their current modern route overlaps / follows an **older Diysean route alignment**;
- after the Hollow Watch mural and then the Wayfinder, the party now knows there is something Ancient about the way they are traveling even though they still do not understand the old system's full purpose or extent.

Current Chapter-1 ending after S011:
- **the party does not immediately depart for Dunmere** once the Wayfinder inspection ends;
- Torren calls for an overnight stop / camp and indicates they will continue toward Dunmere in the morning; exact wording is regenerated by the Dialogue Engine;
- the camp is close enough to the final southern-Briar stretch that the party can backtrack to the earlier overgrown side access before departure;
- the Wayfinder clue makes that earlier branch meaningful enough to investigate, creating the Chapter-1 optional cleanup window for the **Cistern Devourer Hunt**;
- when the player advances the story, the group leaves camp **the next morning** and continues toward the already-planned Dunmere destination, now carrying the added knowledge that the road follows / overlaps an Ancient Diysean alignment.

Current Hollow Watch → Wayfinder connection:
- there is **no Hollow Watch rubbing** to place beside the Wayfinder;
- there is **no route plate** to compare against it;
- the party instead recognizes Wayfinder as the **prominent southern formation depicted in the post-Castellan Hollow Watch mural**;
- Wayfinder is **not** a tunnel entrance, and its reason for being prominent in that mural remains unknown.

Terminology / knowledge corrections:
- `Acuity` → **Perception** when naming the Face;
- Face-name `Change` → **Memory**;
- the historical assumption that Cyanis's recovered Card already has a confirmed **Might association** is retired;
- Chapter 1 still does **not** identify the Card as Might, Prime, Last Sentinel, bearer-linked, or an ancient weapon;
- if current dialogue compares Card geometry with Wayfinder notation, it must remain a generic visual/technical similarity rather than a confirmed Face assignment.

The Wayfinder scene should therefore be regenerated by the Dialogue Engine around its preserved function rather than treated as immutable old wording.

### Ch1 C03–C05 — WAYFINDER-CAMP CHARACTER-LIFE WINDOW
All three existing Chapter-1 Character-Life scenes are available during the **Wayfinder-area overnight camp / Chapter-1 cleanup window** after S011 and before departure for Dunmere. The player may complete any, all, or none of them before advancing the chapter.

**C03 — `Torren's Version of Dinner`**
- the existing evening roadside/rest setup already fits the Wayfinder-area camp closely;
- its character-life function and compatible accepted dialogue remain usable;
- no return to an earlier hub is required.

**C04 — `What the Map Says`**
- its old **Brackenwall late-evening route-room** staging is superseded by the Wayfinder-area camp;
- Torren may still be working on ordinary modern route maps / his battered personal map while Cyanis bothers him;
- this remains a pure Character-Life scene: no mandatory story information, no Hunt progression, and **no second Ancient/Wayfinder lore reveal**;
- compatible accepted dialogue may remain, but location- or timing-specific wording that no longer fits the camp should be regenerated by the Dialogue Engine;
- the approved `old slut` / `old cut` gag remains the current wording where that exchange is retained.

**C05 — `Two Professionals Complaining About Cyanis`**
- its old **Brackenwall evening** staging is superseded by the Wayfinder-area camp;
- its Ilyra/Maevra character-life function remains intact;
- exact accepted dialogue may be retained where compatible with the new camp staging.

General camp rule:
- these scenes do not advance the chapter and do not block one another;
- they do not block access to the Cistern Devourer Hunt or other permitted cleanup content;
- the Hunt is reached by **backtracking into southern Briar Passage to the overgrown access Torren pointed out earlier**, after Wayfinder makes its significance clear;
- their exact performance/order remains optional and may be handled by the camp interaction flow.

### Chapter-1 production firewall
Do not restore through old transcript reuse:
- Maevra as a combatant;
- Torren permanently recruited before Hollow Watch resolution;
- Hollow Watch route rubbing;
- Hollow Watch route plate;
- stranded-civilian recruitment;
- false trail / route split / damaged crossing / Old Waystone;
- special-condition/nonlethal Briarhide Stalker logic;
- explicit Card–Castellan explanation;
- Wayfinder as a tunnel entrance;
- **Cistern Devourer Hunt entrance physically located at Wayfinder rather than southern Briar Passage**;
- premature Might / Prime / Last Sentinel identification;
- dialogue implying Wayfinder newly chooses Dunmere as the destination;
- immediate S011 → Dunmere departure with no overnight cleanup window;
- C03/C04/C05 staging that requires an obsolete return to Brackenwall after S011;
- using C04 as a second Ancient-map exposition scene rather than ordinary character-life map work.
...
- **Dunmere was already the party's planned next destination before the Wayfinder discovery**;
- Chapter 2 begins the morning after the Wayfinder-area camp;
- the party continues toward Dunmere along the route they were already taking, now knowing from Wayfinder that it overlaps an older Diysean route alignment;
- the party carries physical copies of the relevant Wayfinder information, but those copies do not create the Dunmere objective;
...
Current authority:
- the **Prisoner Galleries are already inside the Red Transfer Bastion**;
- the party reaches them directly from the Sunken Archive service route after the Leviathan / transfer-record section;
- prisoners remain differentiated adults with agency; treatment is offered with consent and refusal is respected;
- the defensible safe pocket remains valid, and prisoners retain control of its interior door / bar;
- the secret waterworks / flooded Archive route is not a viable general evacuation route for the captive group, especially for injured or weakened people;
- a maintained extraction route toward the **Greenhollow-side corridor** exists, but its gates / controls are operated from the Bastion's active command layer;
- the party's objective becomes taking those controls and returning for the prisoners before evacuation.

Retired from old S014:
- any dialogue or staging where the party learns that a separate place called **the Bastion** lies farther west;
- the line of reasoning that the Prisoner Galleries and Red Transfer Bastion are separate sites connected by a transfer spine;
- any transition that presents S015 as arrival at a new fort.

### Ch2 S015 — RED TRANSFER BASTION COMMAND LAYER / RHAZEK — REOPENED
Historical S015 remains useful for Rhazek's voice, command competence, moral ownership, and boss staging, but current geography and Seyrik foreshadowing control.

Current authority:
- S015 is the party's push **upward/deeper within the same Red Transfer Bastion** from the prisoner infrastructure into its active logistics / command layer;
- Rhazek is actively running the Bastion when the party reaches him, not waiting theatrically;
- Rhazek knowingly authorized and owns the kidnapping / forced-transfer operation;
- the extraction controls needed for the prisoners are in / controlled from this command layer;
- Rhazek remains the one-HP-bar Bastion Master boss unless live encounter authority later revises mechanics;
- Rhazek survives defeat and withdraws while the party prioritizes opening the prisoners' route over pursuing him.

**Mandatory Seyrik foreshadowing:**
- when the party enters / reaches Rhazek's command area, an **unnamed masked second officer is already present and actively speaking / reporting to Rhazek**;
- underlying canon: this officer is **Seyrik Rell**;
- his presence is mandatory foreshadowing, not an optional interchangeable officer beat;
- he is not named as Seyrik, unmasked, explained, or correctly identified by the party/player in Chapter 2;
- exact report wording and staging may be regenerated by the Dialogue Engine, but the function **Seyrik speaking with Rhazek when the party enters** must remain.

### Ch2 S016 — EXTRACTION CAUSEWAY — REOPENED / GREENHOLLOW-SIDE EXIT
Historical S016 remains useful for the evacuation tone, missing-relative thread, and Hold-the-Junction structure, but its old endpoint is obsolete.

Current authority:
- evacuation proceeds from the Bastion / prisoner safe pocket through the maintained route toward the **Greenhollow side**;
- **Hold the Junction** remains the only mandatory authored combat in the extraction beat;
- no second rearguard battle occurs;
- no combat occurs after the final extraction threshold;
- Rhazek remains withdrawn and does not return for a rematch or stinger;
- not every kidnapped / transferred person is accounted for, and missing-person / missing-relative uncertainty remains unresolved;
- clearing the extraction corridor and breaking the Bastion's control **reopens direct Greenhollow ↔ Dunmere travel after Chapter 2**.

Retired from old S016:
- returning the rescued group to Dunmere as the mandatory chapter-ending destination;
