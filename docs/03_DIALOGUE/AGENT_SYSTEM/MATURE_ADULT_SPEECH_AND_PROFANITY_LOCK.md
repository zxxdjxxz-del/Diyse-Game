...
- **Vaelira:** early vocabulary is intentionally clean: `darn`, `darn it`, `shoot`, `heck`, `jerk`, and other natural clean substitutes. Hard profanity in the early phase is reserved for fear/anger/shock/overwhelm breaking through her normal self-editing. Later progression may add `damn`, `hell`, `shit`, `bullshit`, `fuck`, and other adult terms selectively once earned; do not back-port the later register into Chapter 4 merely because the rest of the cast swears freely.
