...
| B03 | Tree / foliage silhouette | **STYLE STUDY SPEC LOCKED — VISUAL STYLE-PASS PENDING** | `B03_FOLIAGE_EXECUTION_V1.md`; `B03_FOLIAGE_STYLE_STUDY_SPEC_V1.md` |
...
| B10 | Verified CC0 prop cluster | QUEUED | — |
...
B03 source analysis and the foliage style-study specification are complete from the actual Map084 tree assets. The locked B03 tests are canopy massing, selective chaotic line weight, clean alpha edges, gameplay-scale silhouette stability, foreground/midground/background simplification, and icon-scale consistency.

The recent repeated B01 stone image generations are not B03 results and do not advance foliage status.
