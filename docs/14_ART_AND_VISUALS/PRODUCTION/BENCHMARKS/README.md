...
The recent repeated B01 stone image generations remain non-authoritative for B03; the later foliage-only B03 board is the visual-direction reference used for the approved foliage style pass.
