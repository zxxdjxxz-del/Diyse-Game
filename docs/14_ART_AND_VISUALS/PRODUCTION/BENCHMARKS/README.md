...
|---|---|---|---|
| B00 | Permanent party / character style anchor | **IN PROGRESS — CYANIS APPROVED / 1 OF 6 LOCKED** | `B00_PARTY_CHARACTER_STYLE_ANCHOR_V1.md`; `CYANIS_CURRENT_VISUAL_LOCK.md` |
...
Cyanis now has the first approved B00 high-resolution master. Its exact render fingerprint and superseded design details are controlled by `CYANIS_CURRENT_VISUAL_LOCK.md`.

The remaining five party members still require new-style high-resolution masters. B00 does not pass until all six are approved and battle/field derivative logic is validated.
