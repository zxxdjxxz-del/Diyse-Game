...
## 2. Permanent Style Pillars

Every final visual asset should satisfy these five pillars.

1. **Mature seinen character language**  
   Grounded anatomy, adult facial structure where appropriate, emotional restraint, dramatic expression, believable wear, and serious fantasy presentation.
...
5. **Gameplay readability**  
   Expressiveness never destroys silhouette, traversal, action readability, interactable visibility, status readability, or combat staging.

---

## 3. Chaotic Variable Line Weight — Canon Grammar
...
- overlapping scratch or hatch accents in pressure/shadow areas;
