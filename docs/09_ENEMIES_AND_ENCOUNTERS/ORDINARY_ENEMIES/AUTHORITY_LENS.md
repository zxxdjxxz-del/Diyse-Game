...
No extra action.
If no other construct is alive, Authority Ray is selected instead.

## Chapter-10 Buried Registry body
| Lv | HP | ATK | MAG | DEF | Spirit | SPD | EVA | SR |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 44 | **940** | 38 | **170** | 70 | **110** | 40 | 5 | 10 |

Chapter-10 actions:
- Authority Ray — **225 Power**, Magical / Colorless, Base Hit100
- Classification Flash — **160 Power per target**, Magical / Lightning, Base Hit100, **15% Stun per target**, 2-round repetition lock
