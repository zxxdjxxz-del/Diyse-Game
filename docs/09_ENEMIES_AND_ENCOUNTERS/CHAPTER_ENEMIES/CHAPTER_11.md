...
- The Custodian — one continuous HP bar / reconciliation states

## Regional Hunt
- Regional Hunt #10 — Authority Remnant
...
> **Power-complete / nonlethal / exact scene placement bounded / no random spawn**

Perfect Administrator retains:
> Lv55 / HP5,800 / ATK180 / MAG198 / DEF137 / Spirit141 / SPD52

One bar. No support wave. No permanent player-state erasure.
...
Support authority:
`../SUPPORT_OBJECTS/CALDER_CROWN_ENGINE_SUPPORTS.md`

Current:
- Protector of Continuity → genuine fresh Crown-Bound Living Anchor;
...
Detailed current authority:
`../STORY_BOSSES/THE_CUSTODIAN.md`

Support authority:
`../SUPPORT_OBJECTS/CUSTODIAN_DOMAIN_SUPPORTS.md`
...
it believes the Entity was destroyed and does not know one fragment survived.
