...
- Warden of the Nameless / Revision Arbiter — one identity / one bar

## Regional Hunt
- Regional Hunt #7 — Rift Gate Colossus
...
- erase equipment/Cards/abilities;
- remove player command categories;
- alter save data.
...
Controlled Prisoner remains explicitly nonlethal.
