...
- Revision Arbiter Open Revision
- Western Rift Engine Engine Core → Rift Incarnate
- Equal Mercy Arbiter Open Sanctuary
- Custodian reconciliation states
- Concordance Guardian Six Faces → Open Concordance
- Worldscar Leviathan Prismatic Confluence
- The Unfinished World WORLDFRAME → WORLDHEART EXPOSED → FINAL CONSTRUCTION
...
- Marshal Varkesh → Rift Conqueror in Chapter 8
- Rhazek → Bastion Devourer in Chapter 9
...
## No invented component HP
A targetable support object/assembly can exist without this migration inventing an unsupported HP pool.
...
- finite two-Servitor support entry at 60% HP;
- Foundry Breaker first eligible at 50% HP;
- Siege Without Return begins at 30% HP;
...
- Blood Matron = Form I;
- Crimson Brood begins at 45% Form-I HP and remains the same bar;
- Perfected War Mother = genuine fresh Form II;
- no Form-I damage spillover;
...
Current release:
- normal at 55% HP;
- early after a resolved action leaves 2+ Restraint Anchors destroyed.
...
- Closed Record opens with 3 Assertion Layers;
- multiple distinct party members act before direct combat fully opens;
- Open Revision begins at 40% HP;
- Open Revision starts with 2 short reconciliation layers;
- no HP refill;
...
Rift Conqueror is a deliberate Varkesh escalation, not possession.
...
Mercy Protocol:
- each normal party round begins with 50% direct-damage reduction;
- one completed support-only Ability/Card/Item or Defend removes that reduction for the rest of the round;
- no new command;
- not Barrier.
...
> **Exposed Rhazek** begins as a same-bar end segment.
...
Form I:
- two finite Authentication Lenses;
- destroyed Lenses stay destroyed;
- remaining Lenses are consumed at transition.

Form II:
- fresh full HP;
- two finite Living Anchor Clamps;
- no Form-I damage spillover;
- no free transition attack;
- party resources do not refresh;
- **Prime availability refreshes**;
...
Continuity Collapse is an interruptible Clamp-linked Preparation, not a Break system.
...
- one finite Varkesh Black Guard;
- East Retreat Beacon;
- West Retreat Beacon.

Capture:
- while either Retreat Beacon survives, Varkesh HP clamps at **3,421 / 20% Max HP**;
- both Beacons destroyed removes that floor permanently;
- Varkesh reaching 0 HP afterward resolves **captured alive**.
...
- deliberate human-controlled war/relic equipment;
- not possession;
...
It is:
- Ancient guardian/control architecture;
...
Form I:
- HP22,500;
- one Heart Manifestation max at 65%;
- Continuity Hunger at 35% same-bar.

Crest Integration:
- consumes any surviving Heart Manifestation;
- no Form-I damage spillover;
- no free transition attack;
- party HP/MP do not refresh;
- **Prime availability refreshes**;
...
- no third combat body.

Heart Manifestation / Unbound Shards are temporary structures of the same one Entity continuity, not additional fragments.
