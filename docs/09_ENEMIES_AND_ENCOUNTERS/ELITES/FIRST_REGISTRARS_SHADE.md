...
Despite its prison/registry presentation, First Registrar's Shade cannot:
- delete levels;
- alter permanent class identity;
- remove equipment;
...
Standing optional-Elite target:
