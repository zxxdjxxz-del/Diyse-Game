...
gain one Archive Burden level, maximum 2.
...
### Transfer Sever
Transfer Window only.

- one party member
- Hybrid / Neutral
- 50% ATK / 50% MAG
- **2 × 245 Power = 490 total**
- Base Hit100 per hit
...
Custody/Archive/Transfer presentation cannot:
- remove levels/classes;
- delete equipment;
- erase Cards or abilities;
