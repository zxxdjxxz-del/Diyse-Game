...
1. exact Auren rewards for the five current ordinary Side Quests;
...
9. exact vendor NPC identity/presentation for several endpoints;
10. optional additional finite copies of Reservoir Tonic / Emergency Kit / Emergency Rally;
11. comprehensive random Consumable-drop probabilities, if any;
12. exact direct-currency chest placement/value map;
13. currency icon/symbol/glyph;
14. runtime shop IDs, stock table schema, save persistence and price UI formatting.
