...
| C03 | **Vital Salve** | Restore 1,500 HP to one ally | normal stock | **1,200** |
| C04 | **Grand Salve** | Restore 2,250 HP to one ally | normal stock | **2,400** |
| C05 | **Company Salve** | Restore 30% Max HP to all conscious active-party members | normal stock | **2,000** |
...
| C13 | **Stability Remedy** | Remove Freeze / Stun / Staggered | normal stock | **150** |
| C14 | **General Remedy** | Remove one eligible ordinary harmful status | normal stock | **500** |
| C15 | **Full Remedy** | Remove all eligible ordinary harmful statuses | normal stock | **1,400** |
