# Diyse — Starting / Join Loadouts

**Status:** **ACTIVE BALANCE-VALIDATION REFERENCE**

This file records guaranteed equipment needed to build the mandatory-route party body. It does not change equipment legality or item acquisition rules.

## Chapter 0 — Cyanis
Guaranteed active loadout:
- **Primary:** Crestblade — +37 ATK / +28 MAG
- **Armor:** Crest Plate — +28 DEF / +21 Spirit
- **Secondary:** Yahtrean Shield — +15 DEF / +10 Spirit

With Level-1 neutral stats and Crest Knight multipliers, Cyanis enters Chapter-0 combat at:
- **HP 231**
- **MP 25**
- **ATK 56**
- **MAG 45**
...
With Level-1 neutral stats and Blue Warden multipliers, Ilyra's Chapter-0 combat body is:
- **HP 220**
- **MP 31**
- **ATK 45**
- **MAG 59**
...
- optional equipment plausibly obtainable before the encounter.

Do not treat shop availability alone as guaranteed ownership.
