...
| Last Erasure | Ruin / Seyrik | Ch8 | Ch12 — The Reforged March |
| Last Sanctuary | Grace / Ilyra | Ch9 | Ch9 — Mercy Is Not Surrender |

Awakening:
- is mandatory story progression;
- does not use Character EXP;
- does not use Class EXP;
- does not use Prime XP;
- does not require materials;
- does not require duplicates;
- does not require Character Quest completion;
- does not consume item/equipment economy.

Bearer association does not owner-lock battle access after acquisition.
