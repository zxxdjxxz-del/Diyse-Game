...
func _build_convoy_road() -> void:
	...
	_add_pad("F01_Breather1", Vector3(18, 0, 20), Vector2(20, 16), _road_material)
	_add_pad("F01_Encounter2", Vector3(10, 0, -15), Vector2(24, 22), _road_material)
	_add_pad("F01_Breather2", Vector3(-4, 0, -33), Vector2(18, 14), _road_material)
	_add_pad("F01_Encounter3", Vector3(-20, 0, -48), Vector2(25, 22), _road_material)
	...
	_add_marker("P01 Combat 1 — Raider + Crossbowman", Vector3(-8, 0, 55))
	_add_marker("P01 Breather 1 — survivor movement", Vector3(18, 0, 20))
	_add_marker("P01 Combat 2 — Raider + Shieldbearer", Vector3(10, 0, -15))
	_add_marker("P01 Breather 2 — wreckage read", Vector3(-4, 0, -33))
	_add_marker("P01 Combat 3 — Hound Rush", Vector3(-20, 0, -48))
	_add_marker("P01 Late-road breathing", Vector3(-5, 0, -82))
...
func _build_wreck_field() -> void:
	...
	_add_pad("F02_MixedPressure", o + Vector3(5, 0, 18), Vector2(22, 20), _wreck_material)
	_add_pad("F02_StoneLineBreather", o + Vector3(-8, 0, 2), Vector2(20, 16), _wreck_material)
	_add_pad("F02_SurvivorRouteHound", o + Vector3(5, 0, -10), Vector2(20, 18), _wreck_material)
	...
	_add_marker("P02 Combat 4 — Crossbowman + Hound", o + Vector3(5, 0, 18))
	_add_marker("P02 Breather — lower stone line", o + Vector3(-8, 0, 2))
	_add_marker("P02 Combat 5 — Survivor-Route Hound", o + Vector3(5, 0, -10))
...
func _build_triage_camp() -> void:
	...
	_add_pad("F04_Pursuer", o + Vector3(-8, 0, -34), Vector2(26, 22), _camp_material)
	_add_pad("F04_FinalBoss", o + Vector3(24, 0, -38), Vector2(34, 26), _camp_material)
	...
	_add_marker("P04 Ilyra", o + Vector3(0, 0, -10))
	_add_marker("P05 Concealed Seyrik", o + Vector3(-8, 0, -34))
	_add_marker("P05-P06 Noncombat Reset", o + Vector3(6, 0, -22))
	_add_marker("P06 Riftmaw + War-Sorcerer", o + Vector3(24, 0, -38))
	_add_marker("P06 East Cut", o + Vector3(45, 0, -34))
	_add_marker("P07 Sweep Start", o + Vector3(0, 0, -48))
