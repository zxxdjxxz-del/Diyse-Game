...
const EXPECTED_TOTAL_SPOKEN := 2317
...
func _run_validation() -> void:
	...
	_expect(scene_count == 60, "Current runtime dialogue scene count changed: expected 60, got %d" % scene_count)
...
func _finish() -> void:
	if failures.is_empty():
		print("Current Chapters 0-3 runtime dialogue Resources validated: 60 scenes / 2317 spoken lines.")
		quit(0)
		return
