...
- Written whole-project authority: **Diyse Clean Active Complete Master Canon v1.60 / Audit75** (August 17, 2026).
...
- Chapters 1–3 are closed authoring authority but still require Resource conversion/implementation validation. That work must translate the approved chapters without re-authoring them.
- Chapter 4 — **The Seventh Reaction** — is the next exact scene-level authoring frontier.
- Completed Chapter 0–3 repository authority packages live in `docs/chapters/`.
...
| Ch1 — Brackenwall and the Wayfinder | CLOSED | pending conversion/validation |
| Ch2 — The Drowned Oath | CLOSED | pending conversion/validation |
| Ch3 — The Old City and Last Sentinel | CLOSED | pending conversion/validation |
| Ch4 — The Seventh Reaction | next authoring frontier | future |

Chapter 3 geography is a hard lock: **Caelora → Old City / Suppressed Archives → separate Cresthaven**. Cresthaven is not inside the Old City.
...
For Chapters 1–3, start from `docs/chapters/CHAPTER_0X_COMPLETE.md` and convert the closed material into the existing dialogue Resource schema. Resource implementation can make bounded technical/staging fixes, but it must preserve protected lines/beats, pair progression, knowledge firewalls, party-state changes, geography, and scene outcomes.

For new dialogue authoring, begin with Chapter 4 rather than repeating Chapter 3.
...
Read `AGENTS.md`, `docs/ACTIVE_CANON.md`, `docs/IMPLEMENTATION_STATUS.md`, `docs/chapters/README.md`, `docs/DIALOGUE_AUTHORING_SCHEMA.md`, `docs/STEP_7C_AUTHORING_TEMPLATE.md`, and the relevant subsystem rules before implementation.